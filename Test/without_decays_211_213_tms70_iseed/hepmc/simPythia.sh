...
#     I copy my s-ch. .cmnd https://github.com/YW-Hsiao/SVJ_CKKWL/tree/main/PYTHIA_Experts_tms/s_ckkwl_tms70/hepmc
#     Main:numberOfEvents = 10000, Random:seed = 100
#     Close decay channels of 4900211 & 4900213
...
now=$(date)
path_sChCkkwl="/youwei_home/SVJ_CKKWL/Test/without_decays_211_213_tms70_iseed"
