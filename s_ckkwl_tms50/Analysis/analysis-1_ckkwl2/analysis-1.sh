...
today=$(date +"%Y/%m/%d")
path_data="/youwei_home/SVJ_CKKWL/s_ckkwl_tms50/root"
path_python_script="/youwei_home/MyHEPTools/svj_analysis"
python_script="analysis-1.py"
path_output="/youwei_home/SVJ_CKKWL/s_ckkwl_tms50/Analysis/analysis-1_ckkwl2"
rinv=0.3
Lambdad=5
version=1
...
python3 $path_python_script/analysis-1.py $path_data/svj_s_ckkwl-2.root 0.4 -1 0 2 0 440 60 1.2 0 0 10000 $path_output $rinv $Lambdad $version > $path_output/ana1_rinv3_Lambdad5_1.log 2>&1
