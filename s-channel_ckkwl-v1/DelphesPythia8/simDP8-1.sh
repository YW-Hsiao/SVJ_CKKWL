...
now=$(date)
path_sChCkkwl="/youwei_home/SVJ_CKKWL/s-channel_ckkwl-v1"
path_DP8="$path_sChCkkwl/DelphesPythia8"
...
cd $path_Delphes
nohup ./DelphesPythia8 $path_DP8/delphes_card_ATLAS.tcl $path_DP8/svj_ckkwl-1.cmnd $path_DP8/svj_ckkwl-1.root > $path_DP8/svj_ckkwl-1.log 2>&1 &
