...
#     nohup python3 $path_python_script/analysis-1.py $path_data/$file_data_4 0.4 -1 0 2 0 440 60 1.2 0 0 10000 $path_output $rinv $Lambdad $version_4_diff > $path_output/$file_log_4 2>&1 &
    echo nh python3 $path_python_script/analysis-1.py $path_data/$file_data_4 0.4 -1 0 2 0 440 60 1.2 0 0 10000 $path_output $rinv $Lambdad $version_4_diff
    echo $path_output/$file_log_4
...
#     nohup python3 $path_python_script/analysis-1.py $path_data/$file_data_8 0.4 -1 0 2 0 440 60 1.2 0 0 10000 $path_output $rinv $Lambdad $version_8_diff > $path_output/$file_log_8 2>&1 &
    echo nh python3 $path_python_script/analysis-1.py $path_data/$file_data_8 0.4 -1 0 2 0 440 60 1.2 0 0 10000 $path_output $rinv $Lambdad $version_8_diff
    echo $path_output/$file_log_8
done
