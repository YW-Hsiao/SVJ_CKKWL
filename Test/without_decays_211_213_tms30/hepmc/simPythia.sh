...
#     I copy my s-ch. .cmnd https://github.com/YW-Hsiao/SVJ_CKKWL/tree/main/PYTHIA_Experts_tms/s_ckkwl_tms30/hepmc
...
now=$(date)
path_sChCkkwl="/youwei_home/SVJ_CKKWL/Test/without_decays_211_213_tms30"
