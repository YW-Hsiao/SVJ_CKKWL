...
#     I use the RAM = 200 GiB limit container.
...
echo "Path of .cmnd file: $path_hepmc"
echo "Path of .log and .hepmc files: $path_re"

cd $path_examples
nohup ./main89 $path_hepmc/svj_ckkwl-3.cmnd $path_re/ckkwl-3_ram200.hepmc > $path_re/ckkwl-3_ram200.log 2>&1 &
